...
//
// Mirrors the grammar wire-format re-export at `./schemas/grammar`. Same
...
// `TProcessingFailure` ships from core — no TypeBox `ProcessingFailureSchema`
// runtime value is exported yet. This file is intentionally type-only for now; when a
