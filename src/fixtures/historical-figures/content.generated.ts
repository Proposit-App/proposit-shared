...
export const documentAboutByCurationId: Record<string, string> = {
    "madison-01": "# About: Federalist No. 10\n\nFederalist No. 10 (1787) is James Madison's essay on the danger that factions — groups united by a common interest adverse to the rights of others or to the common good — pose to popular government. Madison argues that the causes of faction cannot be removed without destroying liberty itself, so a well-constructed government must instead control its _effects_. His remedy is the large commercial republic: by extending the sphere over a great many diverse interests, and by filtering popular will through elected representatives, an extensive union makes it far harder for any single faction to form a tyrannical majority.\n\n_Original summary for this showcase, informed by public sources including Wikipedia._\n\nRead more: [Federalist No. 10 on Wikipedia](https://en.wikipedia.org/wiki/Federalist_No._10) · Full text: [Federalist No. 10 at Wikisource](https://en.wikisource.org/wiki/The_Federalist_Papers/No._10)\n",
    "mill-01": "# About: On Liberty\n\nOn Liberty (1859) is John Stuart Mill's defense of individual freedom against both state power and social conformity. It advances the \"harm principle\": that power may rightly be used over a member of society, against their will, only to prevent harm to others. The excerpt here is Chapter II, \"Of the Liberty of Thought and Discussion,\" where Mill argues that silencing any opinion presumes our own infallibility, and that even a true belief, left uncontested, hardens into dead dogma.\n\n_Original summary for this showcase, informed by public sources including Wikipedia._\n\nRead more: [On Liberty on Wikipedia](https://en.wikipedia.org/wiki/On_Liberty) · Full text: [On Liberty at Wikisource](https://en.wikisource.org/wiki/On_Liberty)\n",
    "singer-01": "# About: The Singer Solution to World Poverty\n\n\"The Singer Solution to World Poverty\" (_The New York Times Magazine_, 1999) presses a stark moral argument: if we can prevent something very bad from happening without sacrificing anything of comparable moral importance, we ought to do it. Money spent on luxuries could instead save the lives of children dying from preventable causes; therefore, Singer argues, affluent people are obligated to give away income beyond what they need for necessities. The essay uses vivid thought experiments to close the felt distance between a child drowning before our eyes and a child dying overseas.\n\n_Original summary for this showcase, informed by public sources including Wikipedia._\n\nRead more: [The Life You Can Save on Wikipedia](https://en.wikipedia.org/wiki/The_Life_You_Can_Save)\n",
    "socrates-01": "# About: Crito\n\nThe Crito is a short dialogue by Plato, set in the prison where Socrates awaits execution. His wealthy friend Crito urges him to escape into exile; Socrates refuses. He reasons that one must never act unjustly — even in return for an injustice suffered — and that fleeing would wrong the laws of Athens that gave him birth, upbringing, and a lifetime of benefit. A citizen who freely remains, he argues, has agreed to obey the city's judgments or persuade it otherwise, and a just life matters more than mere survival.\n\n_Original summary for this showcase, informed by public sources including Wikipedia._\n\nRead more: [Crito on Wikipedia](https://en.wikipedia.org/wiki/Crito) · Full text: [Crito at Wikisource](https://en.wikisource.org/wiki/Crito)\n",
}
    ...
    "historical-figures-madison": [
        {
            ...
            "claims": [
                ...
                },
                {
                    ...
                    "title": "The Union checks faction",
                    "body": "A well-constructed Union tends to break and control the violence of faction, making it a safeguard against domestic faction and insurrection."
                },
                {
                    "symbol": "p1",
                    "title": "Faction ruins popular government",
                    "body": "Instability, injustice, and confusion are the mortal diseases under which popular governments have perished, and faction drives those harms."
                },
                {
                    "symbol": "faction_remedies",
                    "title": "Faction has two remedies",
                    "body": "The mischiefs of faction can be cured only by removing its causes or by controlling its effects."
                },
                {
                ...
                },
                {
                    ...
                    "title": "Majority factions can oppress",
                    "body": "When a faction includes a majority, popular government can let it sacrifice the public good and others’ rights to its ruling passion or interest."
                },
                {
                    "symbol": "republic_representation_cures",
                    "title": "Republics can cure faction",
                    "body": "A republic, which uses representation, offers a cure for faction that a pure democracy lacks."
                },
                {
                    "symbol": "property_divides_society",
                    "title": "Property creates interests",
                    "body": "Unequal distribution of property creates distinct interests and parties, and regulating those interests is a principal task of modern legislation."
                },
                {
                    "symbol": "faction_arises_from_nature",
                    "title": "Faction arises from human nature",
                    "body": "The latent causes of faction are sown in human nature and are activated by religion, politics, leadership rivalries, and unequal property."
                },
                {
                ...
                },
                {
                    ...
                    "title": "The Union outcontrols state factions",
                    "body": "The Union’s greater size and structure make factious combinations harder to form, coordinate, and spread than within the individual States."
                },
                {
                    "symbol": "large_republic_advantage",
                    "title": "Large republics control faction better",
                    "body": "A large republic is more favorable than a small republic for choosing proper representatives and for preventing oppressive faction because it contains more interests, more candidates, and more obstacles to conspiracy."
                },
                {
                ...
                },
                {
                    ...
                    "title": "The federal Constitution balances scale",
                    "body": "The federal Constitution usefully divides authority by sending great and aggregate interests to the national government and local and particular interests to state legislatures."
                }
            ],
            "premises": [
                {
            ...
            "provenance": {
                ...
                "mode": "fast",
                "runAt": "2026-07-08T19:49:12.907Z",
                "sourceFile": "05-federalist-no-10.txt",
                "sourcePath": "examples/texts/05-federalist-no-10.txt",
                "coreVersion": "2.4.3",
                "sharedVersion": "0.35.0",
                "serverVersion": "0.36.4"
            }
        }
    ],
    "historical-figures-mill": [
        {
            "title": "On Liberty",
            "description": "",
            "claims": [
    ...
    "historical-figures-singer": [
        {
            ...
            "claims": [
                ...
                },
                {
                    ...
                    "title": "No clear moral distinction exists",
                    "body": "There is no morally important distinction between a Brazilian who sells a homeless child to organ traffickers and an affluent American who spends on a TV upgrade instead of donating to save children."
                },
                {
                    "symbol": "LuxuryMoneyShouldBeDonated",
                    "title": "Luxury spending should be donated",
                    "body": "Money spent on luxuries rather than necessities should be given to help the world's poor, because necessities already account for much of a household budget."
                },
                {
                ...
                },
                {
                    ...
                    "title": "Others' inaction gives no excuse",
                    "body": "The fact that many others also fail to donate does not make it morally acceptable for one person to withhold aid, just as widespread wrongdoing does not excuse Bob."
                },
                {
                    "symbol": "AffluentSpendingCanSaveLives",
                    "title": "Luxury spending can save lives",
                    "body": "People in affluent countries spend large amounts on nonessential goods and services, and donating that money to charity could save children’s lives."
                },
                {
                    "symbol": "DonationCanSaveChild",
                    "title": "$200 can save a child",
                    "body": "About $200 donated to organizations like Unicef or Oxfam America can help save a child's life by funding effective aid."
                },
                {
                    "symbol": "DonorsResembleBob",
                    "title": "Refusing to donate mirrors Bob",
                    "body": "A person who can afford to donate $200 to overseas aid but does not do so is acting in a way that closely resembles Bob's refusal to save the child on the tracks."
                },
                {
                    "symbol": "WeAreAllInThatSituation",
                    "title": "Everyone faces the same choice",
                    "body": "All people with surplus wealth are in the same basic moral situation as Bob: they must choose between preserving personal comfort and saving an innocent child's life."
                },
                {
                    "symbol": "GiveMostSurplusWealth",
                    "title": "Surplus wealth should be given away",
                    "body": "People with wealth beyond their essential needs ought to give most of it to help people suffering life-threatening poverty, rather than spend it on luxuries."
                },
                {
                    "symbol": "MoralDutyExceedsHumanNature",
                    "title": "Moral duty exceeds human nature",
                    "body": "Even if human nature makes such sacrifice unlikely, people still ought to make it, and knowing that duty helps them live morally decent lives."
                }
            ],
            "premises": [
                {
            ...
            "provenance": {
                ...
                "pipelineVersion": "1.0.0",
                "mode": "fast",
                "runAt": "2026-07-08T19:49:14.308Z",
                "sourceFile": "06-singer-solution-to-world-poverty.txt",
                "sourcePath": "examples/texts/06-singer-solution-to-world-poverty.txt",
                "coreVersion": "2.4.3",
                "sharedVersion": "0.35.0",
                "serverVersion": "0.36.4"
            }
