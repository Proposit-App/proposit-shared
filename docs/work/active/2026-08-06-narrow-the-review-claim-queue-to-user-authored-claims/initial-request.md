...
- Release notes, changelog, version cut (**patch**), tag. The publish itself is
  user-gated (NPM MFA) and runs after consumer-side tarball validation.
